...
function registerMetricDeclarationTests({ expect, Registry }) {
...
function registerMetricSeriesTests({ expect, Registry }) {
...
function registerMetricValueTests({ expect, Registry, Counter, Gauge, Histogram, collectDefaultMetrics }) {
...
module.exports = function registerMetricsTests(context) {
    registerMetricDeclarationTests(context);
    registerMetricSeriesTests(context);
    registerMetricValueTests(context);
};
