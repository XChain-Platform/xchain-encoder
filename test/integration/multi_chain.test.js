...
// chain threshold wins. Looking the multisig output up by
// `value === encoder.dustAmount` silently fails to match on Bitcoin under
// that max(), so such a lookup asserts nothing on either chain.
