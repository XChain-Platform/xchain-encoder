...
describe('E2E-7: Complex Parameter & Edge Case Handling', () => {
  ...
  // ── E2E-7.1: TICK with special characters ─────────────────────
  ...
  // ── E2E-7.5: Large amount (big number) ───────────────────────
  ...
  // ── E2E-7.7: Pipe character in memo ───────────────────────────
  ...
  describe('E2E-7.7: Pipe character in memo field', () => {
    it('pipe in memo extends the field count (protocol limitation)', async () => {
      // A memo containing | would be parsed as an extra field by the decoder
      // This is a known protocol characteristic, not a bug
  ...
  // ── E2E-7.9: data + rawData dual parameter ───────────────────
  ...
  // ── E2E-7.10: DISPENSER with all fields ──────────────────────
  ...
  // ── E2E-7.11: ORDER with expiration=0 ────────────────────────
  ...
  // ── E2E-7.12: BATCH with 10+ actions ─────────────────────────
  ...
  // ── E2E-7.13: Custom dust parameter ──────────────────────────
  ...
  // ── E2E-7.14: ISSUE with all locks enabled ───────────────────
