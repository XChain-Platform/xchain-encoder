 ...
 **********************************************************************
 *
 * XChain Encoder - global in-flight concurrency gate
 *
 ...
 * link) stays under every per-IP bucket while saturating the upstream node
 * RPC path and every event-loop slot, so the service degrades into timeouts
 * for everybody instead of refusing the excess. This gate counts requests actually in
