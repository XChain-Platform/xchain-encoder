 ...
 * The encoder is called cross-origin by more than one wallet shell (the iOS
 * store build sends `capacitor://localhost`, Android `https://localhost`, the
 * hosted web wallet its own https origin), so an allowlist is the real shape of
 * the setting and a single string never was.
 *
