...
app.get('/status', async (req, res) => {
    ...
    res.status(code).json({ status: healthy ? 'healthy' : 'unhealthy', tracker_reachable, tracker_synced, tracker_lag, request_gate: requestGate.getStats(), probe_gate: probeGate.getStats() })
})
